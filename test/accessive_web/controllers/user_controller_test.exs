defmodule AccessiveWeb.UserControllerTest do
  use AccessiveWeb.ConnCase

  import AccessiveWeb.AuthCase
  alias Accessive.Accounts
  ...
  setup %{conn: conn} = config do
    conn = conn |> bypass_through(AccessiveWeb.Router, [:browser]) |> get("/")
